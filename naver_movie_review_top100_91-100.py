...
def get_reviews(page_num, released, header, movie_info):
    ...
    for j in range(1, page_num+1):
        ...
        if j%10==0 or j==page_num:
            with open('./review_top100_{}.csv'.format(movie_title), 'a', encoding='utf8') as csvfile:
...
with open('./popularmovie_2015-2017(91-100).csv', 'r',encoding='utf-8') as csvfile:
...
for movie in movie_list:
    ...
    get_reviews(page_num, True, header, movie)
    ...
    # get_reviews(page_num2, False, header, movie)
